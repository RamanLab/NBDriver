...
library(caret)
library(mltools)
martelotto_labels_by_15_tools=read.table("/data/shayantan/NBDriver/python/data/Martelotto_labels.txt",sep = "\t",header = TRUE)
Martelotto_for_validation=read.table("/data/shayantan/NBDriver/python/data/Martelotto_for_validation.txt",sep="\t",header = TRUE)
