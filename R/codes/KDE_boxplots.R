...
#R codes to plot the window-wise JS distances between the density estimates
library(reshape2)
library(ggplot2)
...
KDE_KMER_orig=read.csv("/data/shayantan/NBDriver/R/data/KDE_KMER_orig.csv",sep = ",",header = TRUE)
KDE_KMER_rand=read.csv("/data/shayantan/NBDriver/R/data/KDE_KMER_rand.csv",sep = ",",header = TRUE)
KDE_OHE_orig=read.csv("/data/shayantan/NBDriver/R/data/KDE_OHE_orig.csv",sep = ",",header = TRUE)
KDE_OHE_rand=read.csv("/data/shayantan/NBDriver/R/data/KDE_OHE_rand.csv",sep = ",",header = TRUE)
KDE_OHE_orig$X=NULL
KDE_OHE_rand$X=NULL
KDE_KMER_orig$X=NULL
KDE_KMER_rand$X=NULL
colnames(KDE_KMER_orig)=n
colnames(KDE_KMER_rand)=n
...
orig_b=read.table("/data/shayantan/NBDriver/R/data/Original_KDE.txt",sep="\t")
rand_b=read.table("/data/shayantan/NBDriver/R/data/Random_KDE.txt",sep="\t")
