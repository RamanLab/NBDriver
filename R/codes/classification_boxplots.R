...
for(k in 1:3){
  print(k)
  print(dim(final_df))
  nm <- list.files(path=paste("/data/shayantan/NBDriver/R/data/boxplot_data/",files_kmer[k],"/",sep=""))
  for(i in 1:40){
    item=nm[i]
    filename=paste(paste("/data/shayantan/NBDriver/R/data/boxplot_data/",files_kmer[k],"/",sep=""),item,sep="")
  ...
  nm_pos <- list.files(path=paste("/data/shayantan/NBDriver/R/data/boxplot_data/",files_pos[k],"/",sep=""))
  for(j in 1:4){
    item=nm_pos[j]
    filename=paste(paste("/data/shayantan/NBDriver/R/data/boxplot_data/",files_pos[k],"/",sep=""),item,sep="")
