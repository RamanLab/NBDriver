...
This program performs the repeated 10-fold cross-validation experiments using the ET classifier for the Brown et al. dataset
"""
    ...
    for i in range(0,10):
        ...
        for train_index,test_index in rskf.split(X,y):
            ...
            for j in range(0,len(dat_train)):
                ...
                grid = GridSearchCV(et, param_grid,cv=3)
        ...
        #Results of this analysis or the individual dataframes sen_df,spe_df,auc_df and mcc_df for each window size and feature representation is presnt the folder titled results/KMER_ET_new
def main():
    print("Calculating the ET classifier's performance through repeated CV")
    run_repeatedCV()
