...
This program performs the repeated 10-fold cross-validation experiments using the RF classifier for the Brown et al. dataset
"""
...
def run_repeatedCV():
    ...
    for i in range(0,10):
        ...
        #Results of this analysis or the individual dataframes sen_df,spe_df,auc_df and mcc_df for each window size and feature representation is presnt the folder titled results/KMER_RF_new
def main():
    print("Calculating the RF classifier's performance through repeated CV")
    run_repeatedCV()
